...
class ComplianceService:
    async def run_audit(self) -> dict:
        ...
        try:
            ...
            log.warning("compliance_service.neo4j_offline", error=str(exc))
            results = {
                "rule_1_critical_inspections": [],
                "rule_2_loto_certification": [],
                "rule_3_failure_resolution": [],
                "rule_4_regulated_procedures": [],
                "rule_5_incident_closure": [],
            }
