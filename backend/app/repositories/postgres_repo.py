...
class PostgresRepo:
    """Repository for PostgreSQL operations with offline fallbacks."""
    ...
    async def create_upload(
        ...
        try:
            ...
            log.warning("postgres_repo.create_upload_offline", error=str(exc))
            return Upload(
                job_id=job_id,
                doc_id=doc_id,
                filename=filename,
    ...
    async def get_upload_by_job_id(job_id: str) -> Upload | None:
        try:
            ...
            from app.infrastructure.logger import log
            log.warning("postgres_repo.get_upload_offline", error=str(exc))
            return None
    ...
    async def update_upload_status(
        ...
        try:
            ...
            from app.infrastructure.logger import log
            log.warning("postgres_repo.update_upload_status_offline", error=str(exc))
            return None
    ...
    async def log_chat_message(query: str, answer: str, confidence: float) -> None:
        ...
        try:
            ...
            from app.infrastructure.logger import log
            log.warning("postgres_repo.log_chat_message_offline", error=str(exc))
    ...
    async def log_agent_run(
        ...
        try:
            ...
            from app.infrastructure.logger import log
            log.warning("postgres_repo.log_agent_run_offline", error=str(exc))
    ...
    async def log_evaluation(query: str, latency: float, score: float, details: str) -> None:
        ...
        try:
            ...
            from app.infrastructure.logger import log
            log.warning("postgres_repo.log_evaluation_offline", error=str(exc))
    ...
    async def log_compliance_review(flag_hash: str, status: str) -> None:
        ...
        try:
            ...
            from app.infrastructure.logger import log
            log.warning("postgres_repo.log_compliance_review_offline", error=str(exc))
